### GTEx OPA1 heart RNAseq analysis
### June 27th, 2024
## Code for accessing bulk GTEx RNAseq data to subset specific tissue expression
...
def main():
	...
	PCT_CUTOFF (float, opt): 	% of top/bottom expressor samples to return
	...
	# GENE_ID = 'ENSG00000151012.13' 	# xCT
	AGE_CUTOFF = 79
	CND_CONTROL = {'Hardy Scale': 'Ventilator case'}
	# CND_CONTROL = False
	SEX_CONTROL = True
	N_CUTOFF = 24 	# 41 = xCT 10% (x2) after outliers, 24 = opa 10% (x2) after outliers, vents only, all ages
	...
	# groups_exprDF.to_csv(rf'test_sigOPA_genes.csv')
